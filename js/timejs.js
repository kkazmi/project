...
var counter = 1;
    ...
    function addInput(divName){
         ...
         if (counter == limit)  {
              ...
              newdiv.innerHTML = "Time loop Entry " + (counter + 1) + 
              "<br><div class='row'><div class='col-sm-4 col-xs-12'><div id='form1' runat='server'><img id='blah' class='image' src='https://dummyimage.com/400x300/7a6e7a/fff' alt='your image' /><input type='file' id='imgInp' class='file' /></div></div><div class='col-sm-8 col-xs-12'><div id='dynamicInput'><br><div class='input-group'><input type='text' class='form-control' name='myInputs1' placeholder='Name' aria-describedby='basic-addon2'><span class='input-group-addon' id='basic-addon2'>User Name</span></div><br><div class='input-group'><input type='text' class='form-control' name='myInputs1' placeholder='Mobile Number' aria-describedby='basic-addon2'><span class='input-group-addon' id='basic-addon2'>Mobile Number</span></div><br><div class='input-group'><textarea rows='4' cols='50' class='form-control' name='myInputs1' placeholder='Recipient's username' aria-describedby='basic-addon2'>Your Address</textarea><span class='input-group-addon' id='basic-addon2'>Address</span></div></div></div></div>";
